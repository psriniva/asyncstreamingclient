...
java -Xmx4096m -Xms4096m -Dconfig.properties=${ABS_CONFIG_PATH}/${CONFIG_FILE_NAME} -Djava.util.logging.config.file=${ABS_CONFIG_PATH}/logging.properties -jar ${INSTALL_DIR}/${MAIN_JAR_NAME}-${VERSION}.jar